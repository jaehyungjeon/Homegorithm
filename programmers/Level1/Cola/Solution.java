package programmers.Level1.Cola;

/*
	Question : 오래전 유행했던 콜라 문제가 있습니다. 콜라 문제의 지문은 다음과 같습니다.
	...
	Solution : 1. (n / a) * b 한 값을 계속 더해준다.
			   2. a로 나누고 b만큼 반환해주는 값과 나머지 값을 합산하여 n을 재귀한다.
*/
