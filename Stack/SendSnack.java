...
/*
	Question : 인하대학교 학생회에서는 중간, 기말고사 때마다 시험 공부에 지친 학우들을 위해 간식을 나눠주는 간식 드리미 행사를 실시한다. 
	...
	Solution : 1. 문제를 잘못 이해해서 계속 틀렸던 문제
			   2. 큐에서 순서대로 값을 뽑고 다음 순서가 스택의 대기열이나 큐에 있을 경우에는 각각의 저장소에 값을 뽑고 순서를 증가시켜준다.
			   3. 큐와 스택에서 번갈아가면서 저장소를 비울 수 있는 케이스가 아닌 경우 스택에 값이 쌓이게 된다.
			   4. 스택에 데이터가 쌓였을 경우를 대비하여, 스택에서 pop 과정을 진행하며 값을 비교해준다.
			   5. 최종적으로 큐와 스택에 대기가 없을 경우 true로 반환한다.

*/

public class SendSnack {

	public static void main(String[] args) throws Exception {
		// TODO Auto-generated method stub
		BufferedReader br = new BufferedReader(new InputStreamReader(System.in));
		Queue<Integer> q = new LinkedList<>(); // line
		Stack<Integer> stack = new Stack<>(); // stay
