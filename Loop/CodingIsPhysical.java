...
/*
	Question : 오늘은 혜아의 면접 날이다. 면접 준비를 열심히 해서 앞선 질문들을 잘 대답한 혜아는 이제 마지막으로 칠판에 직접 코딩하는 문제를 받았다. 
	...
	Solution : 1. 4 * Long + int
			   2. 유의할 점은 정수가 4로 나누어 떨어지지 않는 경우에 한개의 블럭을 더 생성해주어야 한다는 점..?
