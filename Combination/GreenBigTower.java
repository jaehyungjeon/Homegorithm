...
/*
	Question : Naver D2를 아시나요? D2는 For Developers, By Developers의 약자로, 개발자들을 위해 개발자들이 직접 만들어 가고 있는 네이버 개발자 지원 프로그램입니다. 
	...
	Solution : 1. shift 연산을 이용하면 편하다.
			   2. 층이 올라갈때마다 2의 제곱승대로 구함.
	   
*/

public class GreenBigTower {
