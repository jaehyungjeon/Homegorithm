...
/*
	Question : 666은 종말을 나타내는 숫자라고 한다. 따라서, 많은 블록버스터 영화에서는 666이 들어간 제목을 많이 사용한다. 
	...
	Solution : 1. input값이 count하는 값과 같을때까지 값을 증가
			   2. 증가한 값에 666이 포함되어 있으면 count 값을 증가
			   3. 최초 666에 증가된 값을 리턴시켜주면 됨.
